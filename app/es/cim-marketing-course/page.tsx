...
export const metadata: Metadata = {
  title: 'Certificación en Marketing Digital CIM',
  description: 'El programa de habilidades en Marketing Digital CIM ofrece estrategias prácticas asociadas a una acreditación respetada internacionalmente para acelerar tu crecimiento profesional.',
};

export default function CIMMarketingCoursePageES() {
  return (
        ...
        <article>
          ...
          <figure className="mb-8">
            <Image
              ...
              alt="Curso de Marketing en Línea CIM"
              width={800}
              height={450}
          ...
          <p className="text-[17px] text-[#4b5563] mb-8 leading-relaxed max-w-3xl">
            El esperado programa de Marketing Digital CIM ofrece estrategias prácticas y centradas en la carrera, junto con una acreditación respetada internacionalmente, diseñada para acelerar rápidamente tu trayectoria profesional.
          </p>
          ...
          <div className="border border-[#e5e7eb] rounded-xl p-6 sm:p-8 mb-10 bg-white">
            <div className="flex flex-col gap-8">
              <FeatureItem 
                icon={<BadgeIcon />}
                title="Acreditación respetada mundialmente"
                description={<><strong className="font-semibold text-gray-800">Completar con éxito el plan de estudios CIM te otorga un diploma autoritativo</strong> que los reclutadores priorizan fuertemente durante el proceso de contratación.</>}
              />
              <FeatureItem 
                icon={<BriefcaseIcon />}
                title="Educación práctica orientada a la acción"
                description={<><strong className="font-semibold text-gray-800">El programa gira en torno a desafíos empíricos</strong> como la estructuración de anuncios, el seguimiento del ROI y el escalado del embudo de conversión que se integran perfectamente en tu flujo de trabajo diario.</>}
              />
              <FeatureItem 
                icon={<LaptopIcon />}
                title="Metodologías de estudio versátiles"
                description={<><strong className="font-semibold text-gray-800">Decenas de academias autorizadas ofrecen clases virtuales o presenciales</strong>, permitiendo a los empleados a tiempo completo mejorar sus habilidades sin interrumpir sus carreras.</>}
              />
              <FeatureItem 
                icon={<UsersIcon />}
                title="Alineación con el aprendizaje corporativo"
                description={<><strong className="font-semibold text-gray-800">Estos caminos de aprendizaje pueden formar la columna vertebral de iniciativas patrocinadas</strong>, respaldadas por el CIM actuando como la principal junta de examen.</>}
              />
            </div>
          </div>
          ...
          <section className="mb-10">
            <div className="flex items-center gap-4 mb-8">
              <ThumbsUpIcon />
              <h2 className="text-[28px] font-bold text-[#1f2937]">Ventajas Clave</h2>
            </div>

            <div className="flex flex-col gap-6 sm:pl-2">
              <CheckPoint 
                title="Programa aplicado"
                description="Fuerte dependencia en la ejecución y técnicas que implementarás a diario, evitando conceptos puramente abstractos."
              />
              <CheckPoint 
                title="Validación corporativa"
                description="Un currículum respaldado por el CIM es profundamente valorado en la esfera corporativa global y frecuentemente acelera los ascensos internos."
              />
              <CheckPoint 
                title="Viabilidad de patrocinio"
                description="Se integra fluidamente en los canales de formación financiados por el estado, eliminando obstáculos financieros."
              />
            </div>
          </section>
...
function CTAButton() {
  return (
    <TrackedCTALink 
      href="/o/es/cim-marketing-course"
      locale="es"
