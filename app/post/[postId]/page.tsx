      ...
      <div className="container py-10">
        <div className="grid md:grid-cols-[70%_30%] gap-6">
          ...
          <div className="flex flex-col gap-6 h-full">
            <div className="group p-4 rounded-lg bg-white dark:bg-additionalText flex flex-col">
               <PostSkeleton />
            </div>
            <div className="group p-4 rounded-lg bg-white dark:bg-additionalText flex flex-col hidden md:flex">
               <PostSkeleton />
            </div>
          </div>
        </div>
          ...
          <div className="mt-6 flex flex-col gap-4 pb-4">
            ...
            {post.paragraphs && post.paragraphs[1] && (
              <div className="pt-6 flex flex-col gap-4">
                ...
                {isEmail && post.paragraphs[1].image?.url && (
                  <div className="w-full relative aspect-[4/3]">
                    <Image
